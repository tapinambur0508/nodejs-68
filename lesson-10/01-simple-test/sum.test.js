...
// if (result1 !== 3) {
//   throw new Error(`Expected 3, get ${result1}`);
// }

// const result2 = sum(1, -2);
// if (result2 !== -1) {
//   throw new Error(`Expected -1, get ${result2}`);
// }

// const result3 = sum("1", -2);
// if (result3 !== -1) {
//   throw new Error(`Expected -1, get ${result3}`);
// }
...
function expect(actual) {
  return {
    toBe(expected) {
      if (actual !== expected) {
        throw new Error(`Expected ${expected}, get ${actual}`);
      }
    },
  };
}
